...
import com.example.crmService.utils.HttpClientUtils;
import com.example.crmService.utils.ConstantWxUtils;
...
public class WxApiController {
    ...
    public String callback(String code,String state){
        ...
        //2. 拿着code请求微信固定的地址，拿到两个值 accsess_token和open_id
        String baseAccessTokenUrl = "https://api.weixin.qq.com/sns/oauth2/access_token" +
                "?appid=%s" +
                "&secret=%s" +
                "&code=%s" +
                "&grant_type=authorization_code";
        //拼接三个参数 包括 id  秘钥 和 code值
        ...
        //使用httpclient发送请求，得到返回结果（可以不用浏览器也能模拟出浏览器的请求与过程）
        try {
            ...
            throw new EchoesException(201,"登录失败");
        }
    ...
    //生成微信扫描的二维码
    @GetMapping("login")
    public String getWXCodeForLogin() {
        ...
        try {
            ...
            throw new EchoesException(201,"生成二维码错误");
        }
        //设置%s里面值
